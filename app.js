...
const btnFahrenheit = document.getElementById("btnFah")
...
function convertirDatos(){
    let grades = parseInt(temperature.value)

    if (!isNaN(grades)) {

        let fah = (grades * 9/5) + 32
        let kelvin = grades + 273.15;

        console.log("Los grados celsius en fahrenheit son: " + fah+" F°");
        console.log("y en kelvin son: "+kelvin+" K");
    } else {
